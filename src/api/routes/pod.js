...
router.route('/').get(requiresSubscription(), Pod.index);
router.route('/').post(requiresPodCountCheck(), Pod.create);
...
router.route('/request-member-access').put(requiresPodCountCheck(), Pod.allterMembers);
